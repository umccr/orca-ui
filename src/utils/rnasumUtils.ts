...
/**
 * Defining TISSUE CODE option available for RNAsum
 * Ref: https://github.com/umccr/RNAsum/blob/master/TCGA_projects_summary.md
 */
export const TISSUE_CODES = [
  {
    code: '1',
    letter_code: 'TP',
    definition: 'Primary solid Tumour',
  },
  {
    code: '3',
    letter_code: 'TB',
    definition: 'Primary Blood Derived Cancer - Peripheral Blood',
  },
];
