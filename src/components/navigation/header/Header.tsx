          ...
          <div className='mx-auto max-w-7xl px-2 sm:px-4 lg:px-8'>
            <div className='flex h-12 justify-between'>
              ...
              <div className='hidden lg:ml-4 lg:flex lg:items-center'>
                <button
                  type='button'
                  className='relative flex-shrink-0 rounded-full bg-blue-800 p-1 text-white hover:text-gray-500 focus:outline-none '
                >
                ...
                <Menu as='div' className='relative ml-4 flex-shrink-0'>
                  <div>
                    <MenuButton className='relative flex rounded-full bg-blue-800 p-1 text-white hover:text-gray-500 focus:outline-none'>
                      <span className='absolute -inset-1.5' />
