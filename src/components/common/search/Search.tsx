  ...
  return (
    <div className='flex w-full flex-row items-center gap-2'>
      <div className='relative flex-1'>
        ...
        <div
          className='relative flex w-full flex-row items-center rounded-lg shadow-xs transition-shadow duration-200 hover:shadow-md dark:shadow-gray-800'
        ...
        >
          ...
          <input
            ...
            id='search'
            name='search'
            className='block h-8 w-full rounded-md border-0 bg-white py-1.5 pr-3 pl-10 text-sm text-gray-900 ring-1 ring-gray-300 transition-all duration-200 ease-in-out placeholder:text-gray-400 focus:ring-2 focus:ring-blue-600 focus:outline-hidden dark:bg-gray-800 dark:text-gray-100 dark:ring-gray-700 dark:placeholder:text-gray-500 dark:focus:ring-blue-500'
      ...
      {showTooltip && (
        <Tooltip
          ...
          size='small'
          background='light'
          className='max-w-[600px] min-w-[300px] whitespace-normal'
        >
