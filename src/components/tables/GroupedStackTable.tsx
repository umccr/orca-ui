...
const GroupedStackTable: FC<GroupedTableProps> = ({
  ...
  return (
    <div className='w-full'>
              ...
              <table className='min-w-full divide-y divide-gray-300 dark:divide-gray-700'>
                ...
                <tbody className='divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900'>
                  {tableData.length === 0 && !isFetchingData && (
                    <tr>
                      <td colSpan={columns.length} className='px-8 py-3 text-sm text-gray-500'>
                        No data found
                      </td>
                    </tr>
                  )}
                        ...
                        >
                          {columns &&
                            columns.map((column, index) => (
                              ...
                              >
                                {column.cell
                                  ? column.cell(data.groupTitle[column.accessor], data.groupTitle)
      ...
      {paginationProps && !isFetchingData && tableData.length > 0 && (
